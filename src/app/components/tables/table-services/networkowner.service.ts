...
function matches(networkowner: NetworkOwner, term: string, pipe: PipeTransform) {
  return networkowner.firstName.toLowerCase().includes(term.toLowerCase()) ||
         networkowner.email.toLowerCase().includes(term.toLowerCase()) ||
         networkowner.phone.toLowerCase().includes(term.toLowerCase()) ||
         networkowner.company.toLowerCase().includes(term.toLowerCase()) ||
