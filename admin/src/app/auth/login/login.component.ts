...
export class LoginComponent implements OnInit {
    ...
    constructor(public authService: AuthService, private fb: FormBuilder, private modalService: NgbModal,
        ...
        this.loginForm = this.fb.group({
            username: ['sanjay@gmail.com', [Validators.required, Validators.email]],
            password: ['sanjay', Validators.required]
        });
    }
    ...
    login() {
        ...
        */
        ...
        this.http.get<any>('/api/adminlogin' + queryString).subscribe(data => {
            console.log(data);
            if(data.status == true) {
